...
module alinx_ov5640(
	...
	output [31:0]                                m_axis_video_tdata,    // AXI4-Stream data
	...
	output[3:0]                                  m_axis_video_tkeep,    // AXI4-Stream tkeep
...
assign m_axis_video_tkeep = 4'b1111;
...
assign vid_io_in_data = {cmos_d_16bit[4:0],3'd0,cmos_d_16bit[10:5],2'd0,cmos_d_16bit[15:11],3'd0};
