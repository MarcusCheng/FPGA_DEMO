...
HD_PWD='F:/AX7010/labs/HDMI_output_test/HDMI_output_test.runs/video_pll_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log video_pll.vds -m64 -mode batch -messageDb vivado.pb -notrace -source video_pll.tcl
